...
const links = [
  ...
  {
    name: 'GitHub',
    href: 'https://github.com/nlubalo'
  },
  {
    name: 'Blog',
    href: 'https://medium.com/@nlubalo'
  },
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/in/nancy-lubalo/'
  },
  {
    name: 'Resume',
    href: '/nlubalo.pdf'
  ...
  return (
    <motion.div className='rounded-full w-20 lg:w-auto lg:h-20 flex lg:flex-row flex-col-reverse items-center justify-center fixed top-5 right-5 z-50'>
      ...
      >
        {links.map(link => {
          return (
            <Link legacyBehavior scroll={false} key={link.name} href={link.href}>
